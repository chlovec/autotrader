...
os.close(_db_fd)
os.environ.setdefault("BACKEND_V2_DATABASE_URL", f"sqlite:///{_db_path}")
...
from db.models import OhlcBar, Ticker, TickerBarSyncState  # noqa: E402
from db.session import SessionLocal, init_db  # noqa: E402
from jobs.sync_bars import fetch_and_store_bars, sync_bars_manual, sync_bars_nightly  # noqa: E402
